    ...
    public boolean initialize() {
        try {
            ...
            if (initParams.isSSLRequired()) {
                ...
                trustStore.load(new FileInputStream(new File("conf/servertestkeystore")), "changeit".toCharArray());
            ...
            Scheme plainsch = new Scheme("http", PlainSocketFactory.getSocketFactory(), 22001);
